...
describe("canLoad", () => {
    describe("can load from", () => {
        test("extension", () => {
            ...
            expect(loader.canLoad("file.yaml")).toBe(true);
        });
        ...
        test("a local file", () => {
            ...
            expect(loader.canLoad("file:///c:/file.yaml")).toBe(true);
        });
        ...
        test("a network file", () => {
            ...
            expect(loader.canLoad("\\\\machine\\folder\\file.yaml")).toBe(true);
        });
    });
    ...
    describe("can't load from", () => {
        ...
        test("an unknown extension", () => {
            ...
            expect(loader.canLoad("https://localhost/file.txt")).toBe(false);
        });
    });
});
